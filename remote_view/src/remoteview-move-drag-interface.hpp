 ...
 */
class scale_around_grab_t : public wf::scene::view_2d_transformer_t
{
  public:
    /**
    ...
    scale_around_grab_t(wayfire_view view) : view_2d_transformer_t(view)
    {
        scale_factor.animate(1.0, 1.0);
    }
...
class core_drag_t : public signal::provider_t
{
    ...
    void rebuild_wobbly(wayfire_toplevel_view view, wf::point_t grab, wf::pointf_t relative)
    {
        ...
        modify_wobbly(view, remoteview_move_drag::find_geometry_around(dim, grab, relative));
    }
  ...
  public:
        ...
        const drag_options_t& options)
    {
        ...
        for (auto& v : target_views)
        {
            ...
            auto tr = std::make_shared<remoteview_move_drag::scale_around_grab_t>(v);
            dragged.transformer = tr;

            tr->relative_grab = remoteview_move_drag::find_relative_grab(
    ...
    void start_drag(wayfire_toplevel_view view, wf::point_t grab_position, const drag_options_t& options)
    {
        ...
        start_drag(view, grab_position, remoteview_move_drag::find_relative_grab(bbox, grab_position), options);
    }
    ...
    void handle_motion(wf::point_t to)
    {
        if (view_held_in_place)
        {
            if (distance_to_grab_origin(to) >= (double)params.snap_off_threshold)
            {
                ...
                remoteview_move_drag::snap_off_signal data;
    ...
    void handle_input_released()
    {
        ...
        remoteview_move_drag::drag_done_signal data;
        ...
        for (auto& v : all_views)
        {
            ...
            v.view->get_transformed_node()->rem_transformer<remoteview_move_drag::scale_around_grab_t>();
  ...
  private:
    ...
    void update_current_output(wf::point_t grab)
    {
        ...
        if (output != current_output)
        {
            ...
            remoteview_move_drag::drag_focus_output_signal data;
